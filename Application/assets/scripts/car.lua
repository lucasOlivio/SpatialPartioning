...
function onstart()
    ...
    -- Example usage:
    local moveCommand1 = commands.MoveCommand(entity, {5000.0, 9000.0, 0.0}, 6, 0.0, 0.0, false)
    local moveCommand2 = commands.MoveCommand(entity, {5000.0, 11000.0, 0.0}, 6, 0.0, 0.0, false)
    local moveCommand3 = commands.MoveCommand(entity, {0.0, 10000.0, 0.0}, 6, 0.0, 0.0, true)
