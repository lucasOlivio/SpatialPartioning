...
const glm::vec3 X_VECTOR = glm::vec3(1.0f, 0.0f, 0.0f);
const glm::vec3 Y_VECTOR = glm::vec3(0.0f, 1.0f, 0.0f);
const glm::vec3 Z_VECTOR = glm::vec3(0.0f, 0.0f, 1.0f);

const glm::vec4 RIGHT_VECTOR = glm::vec4(1, 0, 0, 0);
const glm::vec4 UP_VECTOR = glm::vec4(0, 1, 0, 0);
const glm::vec4 FORWARD_VECTOR = glm::vec4(0, 0, -1, 0);
